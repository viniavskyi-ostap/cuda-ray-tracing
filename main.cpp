...
int main() {
    ...
    auto diffuse = std::make_shared<diffuse_t>(Vector3d(0.25, 0.25, 0.25), 8);
    auto metal = std::make_shared<metal_t>(Vector3d(0.85, 0.15, 0.15), 1);
    ...
    scene_t scene{&ground_sphere, &mesh};
